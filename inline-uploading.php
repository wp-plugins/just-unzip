<?php
/**
 * This file contains two functions which are part of the Just Unzip
 * Wordpress Plugin.  
 *
 * The code in just_unzip_attach_to_post is copied
 * from the 'save' action case which is part of the inline-uploading
 * script contained in Wordpress 2.  As such, this function is GPL.
 *
 * The code in just_unzip_handle_zip_upload was written by James
 * Revillini and is LGPL Licensed.
 */
 ...
 * This function encapsulates the logic of part of the switch below
 * which handles the upload action.  It has been made into a function to
 * handle multiple uploads or the result of unzipping an archive upon upload. 	
 */
function just_unzip_attach_to_post($file) {
  global $imgtitle, $descr, $post;
  if ( isset($file['error']) )
